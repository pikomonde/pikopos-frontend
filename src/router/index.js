...
import middlewareProtected from './middlewareProtected'
import middlewareUnprotected from './middlewareUnprotected'
...
const routes = [
  {
    ...
    name: 'home',
    component: Home,
    beforeEnter: (t, f, n) => { middlewareUnprotected(t, f, n) }
  },
  {
    path: '/login',
    name: 'login',
  ...
  },
  {
    ...
    name: 'dashboard',
    component: Dashboard,
    beforeEnter: (t, f, n) => { middlewareProtected(t, f, n) }
  },
  {
